...
<body>
    <h1>Data Logs Entry</h1>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.4.0/jspdf.umd.min.js"></script>
    <div class="header">
        <h1>Data Logs Entry</h1>
        <a href="{{ route('ownershipform') }}" class="btn btn-primary">Enter data Logs</a>
    </div>
...
<div class="pagination">
    ...
    <script>
        ...
        // Function to apply filter based on selected month
